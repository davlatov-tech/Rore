...
pub enum DisplayCommand {
    ...
    // INQILOB: Dasturchining yangi qulayliklari (API) uchun GPU bazasi tayyorlandi
    DrawQuad {
        rect: [f32; 4],
        color_start: [f32; 4],
        color_end: [f32; 4],
        gradient_angle: f32,
        border_radius: [f32; 4], // To'rt xil burchak uchun
        border_width: [f32; 4],  // To'rt tomon qalinligi uchun
        border_color: [f32; 4],
        anim_start_time: f32,
        anim_duration: f32,
    },
