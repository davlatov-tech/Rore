...
pub struct Instance {
    ...
    pub border_radius: [f32; 4], // INQILOB: 4 xil burchak
    pub border_width: [f32; 4],  // INQILOB: 4 xil qalinlik
...
pub struct StyleRaw {
    ...
    pub corner_radii: [f32; 4],  // INQILOB
    pub border_widths: [f32; 4], // INQILOB
    pub extra_props: [f32; 4],   // gradient_angle, 0, 0, 0
    pub anim_data: [f32; 4],
}
